...
const exerciseRows: Array<[
  ...
  ["incline_push_ups", "Wall Push-ups", "Chest", "Beginner", 4, "15", 45, "0659-LEH9jxP.gif"],
  ...
  ["squats", "Air Squats", "Legs", "Beginner", 4, "12", 90, "1685-QChZi3x.gif"],
  ["lunges", "Bodyweight Lunges", "Legs", "Beginner", 3, "10 each", 60, "1688-K9VL0Jq.gif"],
  ...
  ["calf_raises", "Bodyweight Calf Raises", "Legs", "Beginner", 4, "20", 45, "1373-bJYHBIN.gif"],
  ...
  ["plank", "Front Plank", "Core", "Beginner", 3, "45 sec", 45, "0464-CosupLu.gif"],
  ...
  ["jumping_jacks", "Star Jumps", "Cardio", "Beginner", 4, "45 sec", 30, "3223-HtfCpfi.gif"],
  ...
  ["shuttle_runs", "Shuttle Runs", "Cardio", "Intermediate", 6, "30 sec", 45, "3636-ealLwvX.gif"],
  ...
  ["agility_ladder", "Agility Ladder Drills", "Cardio", "Intermediate", 4, "45 sec", 30, "3223-HtfCpfi.gif"],
  ...
  ["wall_sit", "Wall Sit", "Legs", "Beginner", 3, "45 sec", 45, "3533-6YUfHPL.gif"],
  ["single_leg_glute_bridge", "Single-leg Glute Bridge", "Legs", "Intermediate", 3, "12 each", 45, "3561-GibBPPg.gif"],
  ["side_plank", "Side Plank", "Core", "Beginner", 3, "30 sec each", 30, "1774-WL4EmxJ.gif"],
...
const equipmentTierOverrides: Partial<Record<string, ExerciseEquipmentTier>> = {
  ...
  chest_dips: "few",
  deadlift: "few",
  decline_push_ups: "few",
  face_pulls: "few",
  incline_push_ups: "few",
  overhead_press: "few",
  pull_ups: "few",
...
const workoutProgramExerciseIds: Record<string, string[]> = {
  ...
  "athletic-conditioning": ["high_knees", "sprint_intervals", "bear_crawl", "jumping_jacks", "mountain_climbers", "shadow_boxing", "burpees", "plank"],
  "sports-no-equipment": ["high_knees", "sprint_intervals", "bear_crawl", "jumping_jacks", "mountain_climbers", "shadow_boxing", "burpees", "plank"],
  "sports-home-gear": ["shuttle_runs", "agility_ladder", "box_jumps", "jump_rope", "step_ups", "battle_ropes", "farmer_carries", "tuck_jumps"],
